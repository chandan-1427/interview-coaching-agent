...
async def test_analyzer_node(mock_interview_state):
    ...
    with patch("ai_interview_coach.main.global_llm", mock_llm), patch("ai_interview_coach.main.exa_client", None):
...
async def test_run_agent_truncates_long_input():
    ...
    with patch("ai_interview_coach.main.graph", mock_graph), patch("ai_interview_coach.main.mem0_client", None):
...
async def test_handler_initialization_flow():
    ...
    with (
        patch("ai_interview_coach.main._initialized", False),
